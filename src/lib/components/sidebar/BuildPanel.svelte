<script lang="ts">
  ...
  const doorCatalog: { type: Door['type']; name: string; desc: string; icon: string }[] = [
    ...
    { type: 'storefront', name: 'Storefront', desc: '244cm glazed pair', icon: 'M3 3h8v18H3zM13 3h8v18h-8zM5 6h4v9H5zM15 6h4v9h-4z' },
    { type: 'storefront_single', name: 'Storefront (1)', desc: '91cm glazed', icon: 'M6 3h12v18H6zM9 6h6v9H9z' },
  ];
